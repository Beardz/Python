                ...
                while True:
                    if not self.d(text='连接中...').exists:
                        ...
                        if self.d.xpath('//android.widget.ScrollView/android.view.ViewGroup[1]/android.view.ViewGroup['
                                 '1]/android.view.ViewGroup[1]/android.widget.ImageView[1]').exists or self.d(text='蓝牙已连接').exists:
                            for j in range(5):
                            ...
                            if self.d(text='解锁成功').exists(timeout=3):
                                ...
                                logger.error(u'蓝牙假连接')
                                self.write_csv(kind1='蓝牙假连接')
                            time.sleep(1)
                            break
                        else:
                            if self.d(text='稍后再说').exists:
